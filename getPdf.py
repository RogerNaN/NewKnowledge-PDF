...
# 獲得PDF url
def get_pdf_links():
    #url = 'https://www.odyssee-mure.eu/publications/national-reports/' #以odyssee-mure為例
    url = 'https://scholar.google.com.tw/scholar?hl=zh-TW&as_sdt=0%2C5&q=%22machine+learning%22&oq=' #以google scholar machine learning為例
        ...
        for link in links:
            ...
            if href and 'pdf' in href:
                if not href.startswith('http'):
                    href = 'https://www.odyssee-mure.eu' + href  # 可依據網站修改，此處以odyssee-mure為例
